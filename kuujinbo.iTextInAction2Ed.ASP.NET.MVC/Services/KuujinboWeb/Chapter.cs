...
namespace kuujinbo.iTextInAction2Ed.ASP.NET.MVC.Services
{
    public class Chapter
    {
        ...
        public bool IsValidChapterExample
        {
            get
            {
                return !string.IsNullOrEmpty(ChapterName)
                    ...
                    && Chapter.Examples.ContainsKey(ChapterName)
                    && Chapter.Examples[ChapterName].ContainsKey(ExampleName)
                ;
            }
        }
        ...
        public bool IsPdfResult
        {
            get
            {
                return Chapter.Examples[ChapterName][ExampleName].Equals(
                    Chapter.OutputType.pdf
                );
            }
        }
        ...
        public string GetResultName
        {
            get 
            {
                return string.Format(
                    "{0}.{1}.{2}", 
                    ChapterName, ExampleName, 
                    Chapter.Examples[ChapterName][ExampleName]
                );
            }
        }
        ...
        public static readonly Dictionary<string, Dictionary<string, OutputType>> Examples =
            new Dictionary<string, Dictionary<string, OutputType>>()
        {
            {"KuujinboWeb", new Dictionary<string, OutputType>() 
                {
                  {"Chapter", OutputType.none},
